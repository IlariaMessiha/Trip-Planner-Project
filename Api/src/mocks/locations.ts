...
export const barcelonaLocation: Location = {
    ...
    averageRating: 5,
    photos: ["/images/Barcelona1.jpg", "/images/Barcelona2.jpg", "/images/Barcelona3.jpg", "/images/Barcelona4.jpg"],
...
export const niceLocation: Location = {
    ...
    country: 'France',
    continent: 'Europe',
    coverImage: "/images/nice.jpg",
    averageRating: 4,
    photos: ["/images/Barcelona1.jpg", "/images/Barcelona2.jpg", "/images/Barcelona3.jpg", "/images/Barcelona4.jpg"], description: "Porto is a coastal city in northwest Portugal known for its stately bridges and port wine production. In the medieval Ribeira (riverside) district, narrow cobbled streets wind past merchants’ houses and cafes. "
...
export const rioDeJaneroLocation: Location = {
    ...
    coverImage: "/images/rio de janeiro.jpg",
    averageRating: 4,
    photos: ["/images/Barcelona1.jpg", "/images/Barcelona2.jpg", "/images/Barcelona3.jpg", "/images/Barcelona4.jpg"], description: "Porto is a coastal city in northwest Portugal known for its stately bridges and port wine production. In the medieval Ribeira (riverside) district, narrow cobbled streets wind past merchants’ houses and cafes. "
...
export const newYorkLocation: Location = {
    ...
    continent: 'America',
    coverImage: "/images/new york.jpg",
    averageRating: 2,
    photos: ["/images/Barcelona1.jpg", "/images/Barcelona2.jpg", "/images/Barcelona3.jpg", "/images/Barcelona4.jpg"], description: "Porto is a coastal city in northwest Portugal known for its stately bridges and port wine production. In the medieval Ribeira (riverside) district, narrow cobbled streets wind past merchants’ houses and cafes. "
}
